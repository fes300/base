...
// controllers
use Giulia\Controller\AdminController;
use Giulia\Controller\WebsiteController;

// repositories
use Giulia\Repository\MandrillApi;
use Giulia\Repository\UserRepository;
...
$app->post('/sendMail', function ()  use ($app) {
    ...
    $template_name = 'GiuliaContactForm';
    $async = false;
    $ip_pool = 'Main Pool';
    ...
    if(!empty($_POST['email'])){
        ...
        $message = $mandrillFunctions->sendMessage($_POST);
        $template_name = 'GiuliaRequestReceived';
