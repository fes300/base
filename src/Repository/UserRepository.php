...
use App-zero\Model\UserModel as User;
...
class UserRepository extends Repository{
    ...
    function insert($agent) {
        ...
        $data = [
            ...
            'domains' => json_encode($agent->domains),
    ...
    function getUsersForSilex() {
        $users = $this->db->fetchAll('SELECT username, password, role FROM users WHERE active = true');
    ...
    function update($post){
        ...
        $query = $qb->update('users')
                ...
                ->set('company', $qb->expr()->literal($post->company))
